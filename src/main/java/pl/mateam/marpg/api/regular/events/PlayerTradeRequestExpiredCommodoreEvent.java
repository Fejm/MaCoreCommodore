...
public class PlayerTradeRequestExpiredCommodoreEvent extends CommodoreEvent {
	...
	public PlayerTradeRequestExpiredCommodoreEvent(ExtendedPlayer requestSender, ExtendedPlayer requested) {
