...
public class PlayerTradeRequestSendCommodoreEvent extends CommodoreEvent {
	...
	public PlayerTradeRequestSendCommodoreEvent(ExtendedPlayer requestSender, ExtendedPlayer requested, boolean accepted) {
